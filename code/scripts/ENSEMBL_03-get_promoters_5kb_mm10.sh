...
cat Ensembl.ensGene.mm10.collapsed.bed | \
	awk -F "\t" 'BEGIN{OFS="\t";} {if($6 == "+") {print $1,$2-2500,$2+2500,$4,$5,$6} else print $1,$3-2500,$3+2500,$4,$5,$6}' > \
	Ensembl.ensGene.mm10.collapsed.promoter5kb.bed
...
R --vanilla -e "
  ...
  library(rtracklayer)
  promoters <- import('Ensembl.ensGene.mm10.collapsed.promoter5kb.bed')
  ...
  export(object = promoters_fixed, con = 'Ensembl.ensGene.mm10.collapsed.promoter5kb.bounded.bed')
"
