...
```{r ms, fig.width = 9, fig.height = 4, dependson = "load_ms"}
...
```{r h3k27ac_pervasive, fig.width = 6, fig.height = 3, dependson = 'h3k27ac'}
...
```{r load_deeptools, dependson = 'deeptools_input'}
...
```{r norm_deeptools, dependson = 'deeptools_input'}
...
```{r collate_map, dependson = c('deeptools_input', 'make_annot')}
...
```{r collapse_bed, dependson = c('deeptools_input', 'make_annot')}
...
```{r assign_bins, dependson = c('deeptools_input', 'make_annot')}
...
```{r join_annot, dependson = c('deeptools_input', 'make_annot')}
...
```{r barplot_genomic_regions, dependson = c('deeptools_input', 'make_annot'), fig.width = 8, fig.height = 9}
...
```{r dotplot_genomic_regions, dependson = c('deeptools_input', 'make_annot'), fig.width = 5, fig.height = 4, echo_fig = TRUE}
...
```{r H3K27me3_scatter, fig.width = 12, fig.height = 3}
...
```{r H3K27me2_scatter, fig.width = 12, fig.height = 3}
...
```{r dotplots_cgi_H3K27me3, fig.width = 14, fig.height = 5.5, echo_fig = TRUE}
...
```{r dotplots_cgi_H3K27me3_exp, fig.width = 5, fig.height = 6, echo_fig = TRUE}
...
```{r dotplots_100kb_H3K27me2, fig.width = 14, fig.height = 5.5, echo_fig = TRUE}
...
```{r dotplots_100kb_H3K27me2_exp, fig.width = 5, fig.height = 6, echo_fig = TRUE}
...
```{r H3K27me2_domains, fig.width = 6.5, fig.height = 4, message = FALSE}
...
```{r domain_length_dist, fig.width = 5, fig.height = 3}
